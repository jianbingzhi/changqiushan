...
| 2 半占位 | 2.1 C1 综合态势（迁移 realtime + 重着色，地图占位） | [x] | _见下_ |
| | 2.2 C6 数字孪生（孪生面板真实，地图占位） | [x] | _见下_ |
| 3 收口 | 3.1 C7 运营宣传一张图（三区真实，GIS/漫游占位） | [x] | _见下_ |
| | 3.2 占位边界登记 `docs/待办清单.md` + 静态闸（tsc/lint/中文红线） | [x] | _见下_ |
